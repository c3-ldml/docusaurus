...
To use [Generative AI](../../generative-ai.mdx#generate-flows) technology for creating a new Flow with pre-configured Nodes based on your scenario, do the following:
