...
| Enable Speech-to-Text         | Toggle | Toggle whether the Webchat should feature a microphone button. <br /> In the Webchat v3 Endpoint, this parameter is located in the [Webchat Behavior](v3/configuration.mdx#webchat-behavior) settings and applies to both Demo and Production Webchats. <br /><br /> Note that this parameter is not supported by the Mozilla Firefox browser. |
| Enable Text-to-Speech         | Toggle | Toggle whether the Webchat should read all bot messages aloud. <br /> In the Webchat v3 Endpoint, this parameter is located in the [Webchat Behavior](v3/configuration.mdx#webchat-behavior) settings and applies to both Demo and Production Webchats.                                                                                              |
...
- [Webchat v3: Configuration](v3/configuration.mdx)
- [Webchat v2: Configuration](v2/configuration.mdx)