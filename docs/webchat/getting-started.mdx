...
- [Explore the key features of Webchat v3](v3/features.mdx)
- [Discover the Endpoint settings to tailor Webchat v3 according to your preferences](v3/configuration.mdx)
- [Learn how to deploy the application on your website](v3/embedding.mdx)