...
[^*]: If you integrate Webchat v3 with a contact center, note that only [Cognigy Live Agent](../../live-agent/index.md) and [Genesys Cloud Open Messaging](../../ai/human-escalation/handover-reference/genesys-cloud-open-messaging.md) support the Webchat v3 typing indicator.
