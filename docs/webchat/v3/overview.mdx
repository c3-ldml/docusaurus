...
[^*]: If you integrate Webchat v3 with a contact center, note that only [Cognigy Live Agent](../../live-agent/index.mdx) and [Genesys Cloud Open Messaging](../../ai/human-escalation/handover-reference/genesys-cloud-open-messaging.mdx) support the Webchat v3 typing indicator.
...
If you're using Webchat v2 and looking to transition to Webchat v3, refer to the [migration guide](../migration.mdx).
...
1. [Key Features](features.mdx). Explore the Webchat v3 features.
2. [Supported Browsers](supported-browsers.mdx). Explore the supported browsers for Webchat v3.
3. [Configuration](configuration.mdx). Create a Webchat v3 Endpoint and customize various settings within it.
4. Test your Webchat v3 using the embedded [Demo Webchat](../demo.mdx) within the Endpoint settings, or build Webchat v3 locally using [developer tools](https://github.com/Cognigy/Webchat/blob/main/README.mdx#building-your-webchat).
5. [Embedding](embedding.mdx). Launch the Webchat v3 version on your website.