...
<a href="../release-notes/4.93.mdx" /><img src="https://img.shields.io/badge/Updated in-v4.93(Beta)-purple.svg" alt="Version badge" />
...
You can set up plugins in your code in the embedding code of your [Webchat v3](v3/embedding.mdx) or [Webchat v2](v2/embedding.mdx). To add the plugins in your code, proceed as follows:
...
You can build an [Extension](../ai/resource/extensions.mdx) that sends a message triggering the Webchat plugin,
...
- [Webchat v3](overview.mdx)
- [Webchat v2](overview.mdx)