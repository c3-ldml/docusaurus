...
import kubernetesRepositoryDeprecated from '@site/docs/_includes/release-notes/_kubernetes-repository-deprecated.mdx';
...
will be checked for infections with the "cl.mdx" component.
