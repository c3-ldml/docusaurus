...
- Added a [health insurance AI Agent](../ai/empower/agentic-ai/overview.mdx#job-market), supporting both English and German, to the Job Market
...
- Renamed Contact IDs to User ID in the [Contact Profile](../ai/analyze/contact-profiles.mdx#profile-schema) to eliminate ambiguity and ensure consistency with Insights terminology
