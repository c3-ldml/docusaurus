...
:::warning[Upcoming Feature Deprecations and Removals]
  ...
  - [AudioCodes Nodes](../ai/build/node-reference/voice/audiocodes/overview.mdx) and [Generic Voice Nodes](../ai/build/node-reference/voice/generic/overview.mdx) will be deprecated at the end of February 2025. After this time, you won't be able to create new Nodes, but you can still edit or clone existing ones. Flows with these Nodes will continue to work after the deprecation date.
  - [Webchat v2](../webchat/v2/overview.mdx) has been deprecated in version 4.83 and will be retired in February 2026.
...
- Removed the [GPT Conversation](../ai/build/node-reference/service/gpt-conversation.mdx) and [Send Text](../ai/build/node-reference/basic/send-text.mdx) Nodes. Note that if you are still using them, the Nodes in the existing Flows will continue to work
...
- Added the option to [sort unassigned conversations](../live-agent/conversation/search-and-filter.mdx#sort-conversations) by displaying the oldest ones first
