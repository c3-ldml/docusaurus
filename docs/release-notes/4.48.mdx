...
- Added the [GPT Conversation Node](../ai/build/node-reference/service/gpt-conversation.mdx) in Research preview mode
- Added the option to [generate synonyms](../ai/empower/generative-ai.mdx#generate-lexicons) to the Lexicon Entry Generation setting on the Lexicon page
...
- [Live Agent dashboard](../insights/reports/live-agent.mdx) is available under the feature flag for public beta

#### Improvements

- Added searching by [Session ID](../insights/explorers/transcript.mdx) in Transcript Explorer
...
- Added the [Containment Rate bar chart](../insights/reports/engagement.mdx) to the Engagement dashboard
...
- Added the [STT Hints](../ai/build/node-reference/voice/voice-gateway/parameter-details.mdx) field to the [Say](../ai/build/node-reference/basic/say.mdx), [Question](../ai/build/node-reference/basic/question.mdx), [Session Speech Parameters Config](../ai/build/node-reference/voice/generic/session-speech-parameters-config.mdx), [Set Session Config](../ai/build/node-reference/voice/voice-gateway/set-session-config.mdx), and [Play](../ai/build/node-reference/voice/voice-gateway/play.mdx) Nodes, which allows for using a property from input or context and applying it to the hints
- Added the [Additional Session Parameters](../ai/build/node-reference/voice/voice-gateway/parameter-details.mdx) field to the [Say](../ai/build/node-reference/basic/say.mdx), [Question](../ai/build/node-reference/basic/question.mdx), [Set Session Config](../ai/build/node-reference/voice/voice-gateway/set-session-config.mdx), and [Play](../ai/build/node-reference/voice/voice-gateway/play.mdx) Nodes, which allows for configuring settings using JSON. Any changes made using this field will overwrite any previous configurations in the UI
