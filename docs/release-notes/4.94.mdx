...
:::warning[Upcoming Feature Deprecations and Removals]
  ...
  - [AudioCodes Nodes](../ai/build/node-reference/voice/audiocodes/overview.mdx) and [Generic Voice Nodes](../ai/build/node-reference/voice/generic/overview.mdx) will be deprecated with the release of Cognigy.AI 4.96, on March 4, 2025. After this date, you won't be able to create these types of Nodes, but you can still edit or clone existing ones. Flows with these Nodes continue to work after the deprecation date.
...
- Renamed Insights dashboards to [Insights reports](../insights/glossary.mdx#r) to improve clarity and consistency in terminology. The new term highlights their distinction from interactive dashboards and aligns with industry standards
- Renamed Contact ID to [User ID](../insights/explorers/transcript.mdx#list-of-sessions) to synchronize naming conventions across Cognigy products
- Renamed the [Active Contacts](../insights/reports/overview.mdx#active-sessions) chart to Active Sessions. This change reflects the focus on active conversations as the key indicator
