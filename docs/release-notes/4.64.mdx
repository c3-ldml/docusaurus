...
- Added the Chat mode, LLM provider selection, and debugging options to the [LLM Prompt](../ai/build/node-reference/service/llm-prompt.mdx) Node
...
- Added the opportunity to use [Genesys Notification Forwarder](../ai/deploy/endpoint-reference/genesys.mdx#optional-activate-ai-copilot) via the Genesys Endpoint
...
- Added the [Deepgram](../voice-gateway/references/tts-and-stt-vendors.mdx) speech provider to the Voice Gateway Self-Service Portal
