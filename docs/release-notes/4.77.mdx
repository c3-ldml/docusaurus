...
- The [Webchat v3 Beta](../webchat/v3/overview.mdx) is now available. This means that most of the errors from the Webchat v3 Preview have been fixed, and features from v2 are now included in v3 Beta.
...
- Added the [Google Gemini](../ai/empower/llms/model-support-by-feature.mdx) provider for LLMs
...
- Added [on-premises installation support](../voice-gateway/webapp/speech-services.mdx#on-premises-speech-services) for the following speech service providers: Microsoft Azure Speech Services, Deepgram, and Nuance
