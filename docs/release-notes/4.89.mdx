...
- Moved the [Access Control](../ai/administer/access/admin-center/access-control.mdx) and [Audit Events](../ai/administer/access/admin-center/audit-events.mdx) pages under the [Admin Center](../ai/administer/access/admin-center/overview.mdx). Now, all operations for users with the `admin` role are available in a single interface
