...
1. [Set up your Endpoint for Handover to Live Agent](live-agent-setup-handover-endpoint.mdx)
2. [Set up your Flow for Handover to Live Agent](live-agent-setup-handover-flow.mdx)
