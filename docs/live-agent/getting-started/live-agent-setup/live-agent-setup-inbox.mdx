...
After [setting up Live Agent for your organization](live-agent-setup-org.mdx), configure your default Live Agent Inbox.

## Agent Settings

To create a new Inbox for the Agent, follow these steps:

1. In the Cognigy.AI interface, open an existing [Agent](../../../ai/build/projects.mdx).
...
Now you need to set up a [Handover](live-agent-setup-handover.mdx) to Live Agent.
