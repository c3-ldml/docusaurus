...
- [Live Agent is set up for your Organization](live-agent-setup-org.mdx)
- [The Inbox is created for your Live Agent Account](live-agent-setup-inbox.mdx)
...
When the Endpoint is configured, [set up your Flow for Handover to Live Agent](live-agent-setup-handover-flow.mdx)