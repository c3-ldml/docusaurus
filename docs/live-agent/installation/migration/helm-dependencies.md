...
<a href="Added"><img src="https://img.shields.io/badge/Added_in-v4.44-blue" alt="Version badge" /></a>
...
<Tabs>
  <TabItem value="tab1" label="Delete the secrets (recommended)" default>
  ...
  <TabItem value="tab2" label="Modify the existing secrets">
