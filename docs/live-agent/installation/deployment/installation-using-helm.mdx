...
Once you have a good understanding of how customizing works, you can look at the section [Helm Values](../helm-values/helm-values.mdx), which contains a brief explanation about each value and its purpose.
