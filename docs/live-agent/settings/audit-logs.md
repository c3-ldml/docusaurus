...
<a href="Updated"><img src="https://img.shields.io/badge/Updated_in-v4.57-blue" alt="Version badge" /></a>
...
<img src={require('../../../static/img/_assets/live-agent/LA-audit-logs-update-inbox-changes.png').default} alt="Audit Logs Changes" width="100%" />