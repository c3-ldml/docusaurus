...
hidden: false 
---
import downloadReport from '@site/docs/_includes/live-agent/_download-report.mdx';
...
To learn more about metrics, refer to [Report Metrics](overview.mdx#report-metrics).
