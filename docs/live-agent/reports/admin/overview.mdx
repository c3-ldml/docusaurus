...
hidden: false
---
import reports from '@site/docs/_includes/live-agent/_reports.mdx';


# Administrator Reports

Administrators can monitor the account's performance in terms of [agents](agents.mdx),
[labels](labels.mdx), [Inboxes](inboxes.mdx), [teams](teams.mdx),
and also track [conversation](conversations.mdx) metrics over time periods.
...
- [Supervisor report](../supervisor-overview.mdx)
