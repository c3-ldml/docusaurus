...
In manual mode, conversation can be manually assigned or reassigned to any users with the Live Agent [roles](../../roles.mdx): `Agent`, `Supervisor`, or `Administrator`.
...
After the assignment, the agent or a team can receive a [notification](../../notifications.mdx).
...
If the conversation is reassigned, the agent or a team can receive a [notification](../../notifications.mdx).
...
- [Automatic Conversation Mode](automatic-mode.mdx)
- [Conversation Routing](overview.mdx)