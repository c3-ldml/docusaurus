...
For more information, read the [Account Settings](../settings/account-settings.mdx) documentation.
...
This feature can be particularly useful if you want to use the [AI Copilot](../assistants/ai-copilot.mdx) workspace within your conversation.