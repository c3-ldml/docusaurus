...
- **Cognigy.AI OData Endpoint**. Allows access to raw data through APIs and is highly customizable, making it suitable for integration with BI tools and creating custom reports. For more information about the OData endpoint, read the [Cognigy.AI: OData Analytics Endpoint](../ai/analyze/odata.mdx) documentation.
...
- [Overview](reports/overview.mdx)
- [Engagement](reports/engagement.mdx)
- [NLU Performance](reports/nlu-performance.mdx)
- [Live Agent](reports/live-agent.mdx)
- [Goals](reports/goals.mdx)

And additionally, a set of Explorers:

- [Message Explorer](explorers/message.mdx)
- [Step Explorer](explorers/step.mdx)
- [Transcript Explorer](explorers/transcript.mdx)
...
You can find the [User Menu](../ai/administer/user-menu/overview.mdx) in the upper-right corner of the screen.
...
- [Global Filters](global-filters.mdx)
- [Pre-Aggregation](data-management/pre-aggregation.mdx)
- [Data Expiration](data-management/ttl.mdx)