...
hidden: false 
---
import timeZoneOdataAndInsights from '@site/docs/_includes/insights/_time-zone-odata-and-insights.mdx';
...
:::warning
  ...
  This page explains how the Time Zone works before we start migrating to the [new Insights framework](time-zone-with-pre-aggregation.mdx). If the migration process has not yet started for your organization, this page remains relevant for you.
...
- [Pre-aggregation](pre-aggregation.mdx)
- [Time Zone with Pre-aggregation](time-zone-with-pre-aggregation.mdx)