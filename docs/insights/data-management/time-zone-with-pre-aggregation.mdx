...
import newFramework from '@site/docs/_includes/insights/_new-framework.mdx';
...
After migrating to the new framework, Insights introduced [pre-aggregation](pre-aggregation.mdx) to improve data retrieval performance.
...
- [Data pre-aggregation](pre-aggregation.mdx)
- [Time Zone](time-zone.mdx)