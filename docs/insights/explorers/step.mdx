...
For more information, read the [Global Filter](../global-filters.mdx) documentation. Some **global filters** will become accessible by clicking on **more filters ![insight-filter-black](../../../static/img/_assets/icons/insight-filter-black.svg)** in the filter bar at the top of the **Transcript Explorer** page. 
