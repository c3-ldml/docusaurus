...
For more information, read the [Global Filter](../global-filters.mdx) documentation. Some additional filters become available when you click **more filters ![insight-filter-black](../../../static/img/_assets/icons/insight-filter-black.svg)** in the filter bar at the top of the **Transcript Explorer** page. 
...
- [Cognigy Insights](../overview.mdx)
- [Global Filters](../global-filters.mdx)
- [Step Explorer](step.mdx)
- [Transcript Explorer](transcript.mdx)
- [Cognigy Insights Glossary](../glossary.mdx)
