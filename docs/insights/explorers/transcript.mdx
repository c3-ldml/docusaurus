...
tags:
  ...
  - transcript explorer
---
import resetFilters from '@site/docs/_includes/insights/_reset-filters.mdx';

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';


import excludeFilters from '@site/docs/_includes/insights/_exclude-filters.mdx';
...
For more information, read the [Global Filter](../global-filters.mdx) documentation.
...
| Goals Completed     | Select from predefined goals to narrow down results according to specific objectives or targets configured with [Tasks](../../ai/build/node-reference/overview.mdx).                                                                                                                                                                   |
...
Insights' Debug mode is not fully equal to the Debug mode in the [Interaction Panel](../../ai/test/interaction-panel/overview.mdx#debug-mode) documentation. Debug messages from Nodes (including Code Nodes and Debug Message Nodes) are only for immediate testing and can only be seen in the Interaction Panel.
...
For more information, read the [Playbooks](../../ai/test/playbooks.mdx) documentation.

#### Open Message-Related Flow

To check your [Flow](../../ai/build/flows/overview.mdx) or to improve the configuration, the Transcript Explorer provides the context menu **Open Flow**.
...
You can access the [Message Explorer](message.mdx) by selecting a message within the **Session Transcript** window.
...
| Tasks Completed         | All the tasks that were completed by the user during conversations with AI Agents or human agents. The field refers to the [Tasks](../../ai/analyze/goals-and-tasks/tasks.mdx) feature. |
...
However, the session metadata will remain accessible through the [Cognigy.AI OData endpoint](../../ai/analyze/odata.mdx), except for the data in the [Conversation](../../ai/analyze/odata.mdx#conversations) collection.
Also, the Contact Profile details will still be available in the [Contact Profile](../../ai/analyze/contact-profiles.mdx).

:::note

  If you've migrated to the new [Insights framework](../data-management/pre-aggregation.mdx), there might be a delay between deleting the session transcript and the session itself. When you click the **Delete Session Transcript** button, the transcript is deleted first, and the session is deleted from the **Transcript Explorer** page about 10 minutes later.
...
- [Message Explorer](message.mdx)
- [Insights Glossary](../glossary.mdx)
- [Playbooks](../../ai/test/playbooks.mdx)
- [Interaction Panel](../../ai/test/interaction-panel/overview.mdx)