...
hidden: false
---
import globalFilters from '@site/docs/_includes/insights/_global-filters.mdx';


# Goals

[![Version badge](https://img.shields.io/badge/Added in-v4.94(Beta)-purple.svg)](../../release-notes/4.94.mdx)

:::note

  The Goals Report is in Beta and is available if you have migrated to the new [Insights framework](../data-management/pre-aggregation.mdx).
...
Displays the total number of [completed goals](../../ai/build/node-reference/analytics/track-goal.mdx).

### Partially Completed

Displays the total number of partially [completed goals](../../ai/build/node-reference/analytics/track-goal.mdx).
...
- [Goals](../../ai/analyze/goals-and-tasks/goals.mdx)
- [Overview Report](overview.mdx)
- [NLU Performance Report](nlu-performance.mdx)
