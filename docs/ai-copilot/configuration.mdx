...
- Use the [Copilot: Set Grid Node](../ai/build/node-reference/ai-copilot/set-grid.mdx) (this option is recommended).
...
The Transcript Tile feature is intended specifically for [chat use cases](chat.mdx). For voice-related scenarios, use the [Copilot: Transcript Tile](../ai/build/node-reference/ai-copilot/transcript-tile.mdx) Node.
