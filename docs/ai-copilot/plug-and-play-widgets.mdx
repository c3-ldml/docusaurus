...
- [Copilot: Identity Tile](../ai/build/node-reference/ai-copilot/identity-tile.mdx)
- [Copilot: Next Action Tile](../ai/build/node-reference/ai-copilot/next-action-tile.mdx)
- [Copilot: Sentiment Tile](../ai/build/node-reference/ai-copilot/sentiment-tile.mdx)
- [Copilot: Transcript Tile](../ai/build/node-reference/ai-copilot/transcript-tile.mdx)
- [Copilot: Knowledge Tile](../ai/build/node-reference/ai-copilot/knowledge-tile.mdx)
