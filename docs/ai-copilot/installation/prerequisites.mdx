...
For detailed MongoDB setup and configuration, refer to the [Cognigy.AI Installation Prerequisites guide](../../ai/installation/prerequisites.mdx#kubernetes-cluster).
