...
|----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------|
| .mdx                        | Enable the [Answering Machine Detection](.mdx.mdx) (.mdx).                                                                                                                                                                                                                                 | No                                         |
| bargein                    | A background [`gather`](gather.mdx) verb.                                                                                                                                                                                                                                                | No                                         |
...
| bargeIn.sticky             | If both `bargeIn.enable` and `bargeIn.sticky` are `true`, another background [`gather`](gather.mdx) will automatically initiate after detecting speech or DTMF.                                                                                                                          | No                                         |
...
| bargeIn.n.mdxigits          | The exact number of DTMF digits expected to gather.                                                                                                                                                                                                                                     | No                                         |
...
| listen                     | A nested [`listen`](listen.mdx) verb.                                                                                                                                                                                                                                                    | No                                         |
...
| recognizer                 | Change the session-level default speech recognition settings. See the [`transcribe`](transcribe.mdx) verb for details on the `recognizer` property.                                                                                                                                      | No                                         |
| reset                      | A string or array. Resets either `recognizer` or `synthesizer` to the default application settings.                                                                                                                                                                                     | No                                         |
| record                     | Options to manage call recording using [SIPREC](sip-request.mdx).                                                                                                                                                                                                                        | No                                         |
...
| synthesizer                | Change the session-level default text-to-speech settings. See the [`say`](say.mdx) verb for details on the `synthesizer` property.                                                                                                                                                       | No                                         |
