...
| listenDuringPrompt  | If this parameter is `false`, the system will not listen for user speech until the [`say`](say.mdx) or [`play`](play.mdx) verbs has completed. The default value is `true`. | No       |
...
| n.mdxigits           | The exact number of DTMF digits expected to gather.                                                                                                                       | No       |
...
| play                | A nested [`play`](play.mdx) verb that can be used to prompt the user.                                                                                                      | No       |
...
- [RECOGNIZED_DTMF](../events/RECOGNIZED_DTMF.mdx)
- [RECOGNIZED_SPEECH](../events/RECOGNIZED_SPEECH.mdx)
- [USER_INPUT_TIMEOUT](../events/USER_INPUT_TIMEOUT.mdx)