...
- [Check supported speech vendors](../tts-and-stt-vendors.mdx)
- [Add a custom speech API](../../webapp/speech-services.mdx#add-a-custom-speech-vendor)
...
| synthesizer.voice    | The voice to use. Check the voice lists of the vendor used. Defaults to the [Application](../../webapp/applications.mdx) setting, if provided. Required, if `synthesizer.vendor` is defined | No       |
