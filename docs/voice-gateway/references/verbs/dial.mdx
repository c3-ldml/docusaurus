...
| .mdx            | Enable the [Answering Machine Detection](.mdx.mdx).                                                                                                                                                                                                                                                                                                                                                                                          | No       |
...
| listen         | A nested [listen](listen.mdx) parameter streams call audio to a remote server via websockets.                                                                                                                                                                                                                                                                                                                                               | No       |
...
| transcribe     | A nested [transcribe](transcribe.mdx) action, which will cause the call to be transcribed.                                                                                                                                                                                                                                                                                                                                                  | No       |
...
| trunk       | If provided, this should be the name of a [carrier](../../webapp/carriers.mdx) that you created in the Voice Gateway Self-Service portal, which you want to use to complete this call. If not provided, Voice Gateway will select one of your configured carriers that has an outbound SIP trunk. | No       |
...
The webhook triggers when the `.mdx` parameter is used and Voice Gateway identifies the called party as either human or machine, or detects a tone or beep.

| Property Name | Description                                                                                    |
|---------------|------------------------------------------------------------------------------------------------|
| event         | Indicates one of the following events: `.mdx`, `beep`, or `silence`.                            |
| .mdx_type      | Specifies either `human` or `machine`. This property is provided only when the event is `.mdx`. |

## More Information

- [TRANSFER_DIAL_ERROR](../events/TRANSFER_DIAL_ERROR.mdx)
- [TRANSFER_DIAL_SUCCESS](../events/TRANSFER_DIAL_SUCCESS.mdx)
