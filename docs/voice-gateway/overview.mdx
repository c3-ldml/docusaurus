...
Voice Gateway is installed in addition to the main product [Cognigy.AI](../index.mdx) and cannot be used independently. If you want to use Voice Gateway, contact [Cognigy technical support](../help/get-help.mdx) to get access. 
