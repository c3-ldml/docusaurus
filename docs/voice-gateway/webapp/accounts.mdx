...
*Accounts* are containers for resources such as [applications](applications.mdx), [carriers](carriers.mdx), and [speech services](speech-services.mdx) that are used to create and manage voice applications.
...
All calls from all applications on this account will be recorded and appear in the [Recent calls](recent-calls.mdx#call-recordings) page.
