...
_Phone Numbers_ are routed to your [Endpoints](../getting-started.mdx#create-a-voice-gateway-endpoint). Phone number helps route incoming voice calls to the Cognigy conversation flow. 
