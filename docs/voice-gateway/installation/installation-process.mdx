...
<!---
1. Install Voice Gateway with [Voice Gateway Helm Chart](https://cognigy.visualstudio.com/voice-gateway/_git/voice-gateway-app). For up-to-date installation instructions refer to [README.mdx](https://cognigy.visualstudio.com/voice-gateway/_git/voice-gateway-app?path=/README.mdx)
