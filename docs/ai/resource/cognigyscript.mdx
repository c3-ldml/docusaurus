...
_CognigyScript_ is a superset of JavaScript that provides access to the [Input](../test/interaction-panel/input.mdx), [Context](../test/interaction-panel/context.mdx), and [Profile](../test/interaction-panel/profile.mdx) objects. With CognigyScript expressions, you can retrieve values from JSON properties, and use these values in AI Agent conversations.
...
You can also store CognigyScript in [Tokens](tokens.mdx).
...
- [Context](../test/interaction-panel/context.mdx)
- [Profile](../test/interaction-panel/profile.mdx)
