...
<a href="../../release-notes/4.92.mdx" /><img src="https://img.shields.io/badge/Updated in-v4.92-blue.svg" alt="Version badge" />
...
<Tabs>
  <TabItem value="tab1" label="GUI" default>
    To create a Project with the [Project Creation wizard](#project-creation-wizard), click the **+** button in the upper-left corner of the [Main page](../overview/user-interface/main-page.mdx). On the **Main** page, you can also edit or delete a Project as well as copy a Project's Reference ID.
  ...
  <TabItem value="tab4" label="Agentic AI">
    An autonomous AI Agent driven by large language models (LLMs). You can build an [Agentic AI Agent](../empower/agentic-ai/getting-started.mdx) or hire one from the [Job Market](../empower/agentic-ai/overview.mdx#job-market).

  </TabItem>
  <TabItem value="tab5" label="Intent-driven AI">
    An AI Agent that uses [Intents](../empower/nlu/intents/ml-intents.mdx) to understand user input. You can build an [AI Agent](../../ai/overview/getting-started-with-digital-agent.mdx) and integrate it with [Knowledge AI](../empower/knowledge-ai/overview.mdx), a RAG-based solution that provides context-aware responses.

  </TabItem>
</Tabs>
Projects include [Flows](../resource/flows/overview.mdx), [Endpoints](../deploy/endpoints/overview.mdx), [Connections](connections.mdx), and many other resources you need to build an AI Agent.
...
- Create an [AI Copilot](../../ai-copilot/overview.mdx) Flow by selecting the **Enable AI Copilot** option from the list.
...
<a href="../../release-notes/4.65.mdx" /><img src="https://img.shields.io/badge/Updated in-v4.65-blue.svg" alt="Version badge" />
...
- [User Menu](../administer/user-menu/overview.mdx)
- [Interaction Panel](../test/interaction-panel/overview.mdx)
- [Insights](../../insights/overview.mdx)
- [Analytics](../analyze/overview.mdx)
- [Agentic AI Agent](../empower/agentic-ai/overview.mdx)
- [AI Workforce](../../ai/overview/ai-workforce.mdx)
