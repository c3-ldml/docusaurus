...
<a href="../../../release-notes/4.48.mdx" /><img src="https://img.shields.io/badge/Updated in-v4.48-blue.svg" alt="Version badge" />
...
You can configure channels in the [Say](../node-reference/basic/say.mdx), [Question](../node-reference/basic/question.mdx), and [Optional Question](../node-reference/basic/optional-question.mdx) Nodes. Voice channels support Speech Synthesis Markup Language (SSML), and text-based channels can generate different content type outputs, such as:
...
<CollapsibleSection title="Default AI Channel">
    ...
    The default AI channel is a universal channel and its settings correspond to the parameters in the [Say Node](../node-reference/basic/say.mdx). Use this channel to get more flexibility around different platforms.
...
<CollapsibleSection title="Messenger">
  ...
  You can use the [output action in Code Nodes](../node-reference/basic/code/actions.mdx) to send a JSON object directly to Facebook. To do so, set the following code as the data property:
...
<CollapsibleSection title="Webchat">
    ...
    The Webchat channel defines how AI Agents provide answers through [Webchat v2](../../../webchat/v2/overview.mdx).
  ...
  | Adaptive Card | A `$schema` property for the adaptive card. You can find supported versions in the [Content Conversion](../../deploy/endpoints/content-conversion.mdx) article. |
...
<CollapsibleSection title="Microsoft Teams">
    ...
    With the Microsoft Teams channel, you can send either text or adaptive cards. Refer to [Deployment a Microsoft Teams Endpoint](../../deploy/endpoint-reference/azure-bot-services.mdx) page for information on how to send messages.
  ...
  | Adaptive Card | A `$schema` property for the adaptive card. You can find supported versions in [Content Conversion](../../deploy/endpoints/content-conversion.mdx).                                                                                                                 |
  ...
  You can also configure Voice Gateway settings using Activity Parameters. To do this, activate the **Set Activity Parameters** toggle. You can find a description of the parameter configurations in [Voice Gateway Parameter Details](../node-reference/voice/voice-gateway/parameter-details.mdx).
...
<CollapsibleSection title="8x8">
    ...
    | Adaptive Card | An adaptive card. You can find supported versions in [Content Conversion](../../deploy/endpoints/content-conversion.mdx). |
...
- [Say Node](../node-reference/basic/say.mdx)
- [Question Node](../node-reference/basic/question.mdx)
- [Optional Question Node](../node-reference/basic/optional-question.mdx)