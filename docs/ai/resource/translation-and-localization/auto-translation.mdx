...
- For [Intents](#machine-translation-for-flow-localization), machine translation doesn't match the [Slots](../../empower/nlu/intents/ml-intents.mdx) you set for your primary Locale to the Keyphrases in the localized Example Sentences. After performing an Intent or Multi-Intent localization, check and fix the [Slot annotation](../../empower/nlu/intents/annotations.mdx#example-sentences) in the localized Example Sentences.
...
You can automatically translate [Nodes](../nodes/overview.mdx) and [Intents](../../empower/nlu/intents/ml-intents.mdx) in the [Flow editor](../flows/editor.mdx). To do so, select a Locale in the top bar, go to the Node editor or the **NLU** tab, and click **Add Localization**.
