...
Compared to [Snapshots](../deploy/snapshots.mdx), working with Packages provides more flexibility. With Packages, you have control over which resources you import and export.

Packages can include the following Project resources:

- [Flows](../resource/flows/overview.mdx) (including Nodes and Intents)
- [Lexicons](../empower/nlu/slots-and-lexicons/lexicons.mdx)
- [NLU Connectors](../empower/nlu/external/nlu-connectors.mdx)
- [Endpoints](../deploy/endpoints/overview.mdx)
- [Playbooks](../test/playbooks.mdx)
- [Connections](../resource/connections.mdx)
- [Knowledge Stores](../empower/knowledge-ai/overview.mdx#knowledge-store)
...
- If you export a Package from a Project with [Extensions](extensions.mdx), you must install the respective Extensions in the target Project as well before importing the Package.
...
- [Localization](translation-and-localization/localization.mdx)