...
<a href="../../../release-notes/4.80.mdx" /><img src="https://img.shields.io/badge/Updated in-v4.80-blue.svg" alt="Version badge" />

The _Flow Editor_ is a user interface (UI) where you can see a graphic representation of a [Flow](overview.mdx), the _Flow Chart_, and design AI Agents' conversations. In the Flow editor, the Flow consists of Nodes that represent various actions or decision points. The [Nodes](../nodes/overview.mdx) are linked to one another by lines that indicate the conversation's path, from the **Start** Node to the **End** Node.
...
<CollapsibleSection title="1. Top Bar">
    ...
    Besides the controls from the [Project Page](../../overview/user-interface/project-page.mdx) top bar, the Flow editor includes the following elements from left to right:
    ...
    | NLU             | Tab  | Display the NLU settings, where you can configure [Intents](../../empower/nlu/intents/ml-intents.mdx), [States](../../test/interaction-panel/state.mdx), [Slot Fillers](../../empower/nlu/slot-fillers.mdx), as well as attach [Flows](../../empower/nlu/overview.mdx#attached-flows) and [Lexicons](../../empower/nlu/slots-and-lexicons/lexicons.mdx). |
    | Settings        | Tab  | Display the [Flow Settings](overview.mdx#settings), [Default Context](../../test/interaction-panel/context.mdx), and [Locale Settings](../translation-and-localization/localization.mdx).                                                                                                                                                              |
...
<CollapsibleSection title="2. Flow Chart">
    ...
    |                              Button                              | Description                                                           |
    |:----------------------------------------------------------------:|-----------------------------------------------------------------------|
    | ![flow-plus](../../../../static/img/_assets/icons/flow-plus.svg) | Click to add a new Node or [Extension](../extensions.mdx) to the Flow. |
...
- [Agents](../../overview/ai-workforce.mdx)