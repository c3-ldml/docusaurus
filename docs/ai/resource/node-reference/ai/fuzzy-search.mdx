...
The result is stored in either the [Context](../../../test/interaction-panel/context.mdx) (`context.STORE`) or [Input](../../../test/interaction-panel/input.mdx) object (`input.STORE`) using the store name given in the Node settings.
