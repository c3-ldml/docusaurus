...
<a href="../../../../release-notes/4.51.mdx" /><img src="https://img.shields.io/badge/Added in-v4.51-blue.svg" alt="Version badge" />
...
See the [Text Cleaner](../../../empower/nlu/text-cleaner.mdx) page for more information on the individual functions.