...
The Add Lexicon Keyphrase Node adds new Keyphrases to [Lexicons](../../../empower/nlu/slots-and-lexicons/lexicons.mdx) from the Flow using [CognigyScript](../../cognigyscript.mdx).
