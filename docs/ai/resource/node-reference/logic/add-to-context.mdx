...
This Node stores information in the [Context](../../../test/interaction-panel/context.mdx) object, so that it can be used throughout the session on subsequent user inputs. 
