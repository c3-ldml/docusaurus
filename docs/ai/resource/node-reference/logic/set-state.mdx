...
This Node allows you to control Intent recognition within your Flow by using [States](../../../test/interaction-panel/state.mdx).
...
To restore full Intent recognition to the default State, use the [Reset State](reset-state.mdx) Node.
