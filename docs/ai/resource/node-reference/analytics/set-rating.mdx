...
You can combine this Node with the [Request Rating](request-rating.mdx) Node.
For example,
...
In contrast to the [Request Rating Node](request-rating.mdx), the Set Rating Node doesn't display a rating widget to the end user.
...
- [Request Rating](request-rating.mdx)
