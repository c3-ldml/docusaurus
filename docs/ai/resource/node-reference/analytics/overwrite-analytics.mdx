...
as well as manage the analytics data stored in the [Analytics](../../../analyze/collecting-data.mdx) database.
You can view this data on the [Insights reports](../../../../insights/overview.mdx) or retrieve it via the [Cognigy.AI OData Endpoint](../../../analyze/odata.mdx).
