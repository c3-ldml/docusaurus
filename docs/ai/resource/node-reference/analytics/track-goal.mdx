...
and can be used only with [Goals](../../../analyze/goals-and-tasks/goals.mdx). 
...
- [Goals](../../../analyze/goals-and-tasks/goals.mdx)
- [Goals Report](../../../../insights/reports/goals.mdx)
- [Complete Task Node](complete-task.mdx)