...
import InsightsForRating from '@site/docs/_includes/ai/nodes/_insights-for-rating.mdx';
import RatingUseCases from '@site/docs/_includes/ai/nodes/_rating.mdx';
...
In contrast to the [Set Rating Node](set-rating.mdx), the Request Rating Node doesn't rate a conversation automatically.
...
<CollapsibleSection title="Implement Rating in the Webchat Endpoint">
    ...
    3. Configure the Rating settings as described in the [Deploy Webchat Endpoint](../../../../webchat/v2/configuration.mdx#conversation-rating-settings) documentation.
    4. Click **Save**.
