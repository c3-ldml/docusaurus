...
<a href="../../../../../release-notes/4.45.mdx" /><img src="https://img.shields.io/badge/Added in-v4.45-blue.svg" alt="Version badge" />
...
Note that this Node controls a specific Flow. If you want to enable call recording for all Flows and record entire calls, configure the [Call Recording](../../../../../voice-gateway/webapp/accounts.mdx#call-recording-configuration) setting on the Voice Gateway Self-Service Portals.
