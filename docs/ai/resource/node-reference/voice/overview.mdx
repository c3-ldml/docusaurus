...
<GridCards items={[
  {
    ...
    links: [
      {text: "Documentation", href: "generic/overview.mdx"}
    ]
  },
  {
    icon: "🔊",
    title: "Voice Gateway Nodes",
    description: "Voice Gateway Nodes help you build a voice AI Agent using [Voice Gateway configuration](../../../../voice-gateway/overview.mdx).",
    links: [
      {text: "Documentation", href: "voice-gateway/overview.mdx"}
    ]
  },
  {
    icon: "📞",
    ...
    links: [
      {text: "Documentation", href: "audiocodes/overview.mdx"}
    ]
  }
]} />
