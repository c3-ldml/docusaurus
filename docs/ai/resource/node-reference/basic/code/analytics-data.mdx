...
In a [Code Node](overview.mdx), you can modify certain parts of the analytics data to get more control of what exactly is written to analytics.
...
<CollapsibleSection title="Analytics Data Fields">
    ...
    | state          | The [State](../../../../test/interaction-panel/state.mdx) the Flow is currently in.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | String            |
...
<CollapsibleSection title="Store Complex Custom Data">
    ...
    In this example, `custom1` stores a simple string value, while `custom2` uses a JSON representation of the `cust.mdxata` object to store more complex information.
    ...
    analyticsdata.custom2 = JSON.stringify(cust.mdxata);
    ```
