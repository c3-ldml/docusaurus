...
<CollapsibleSection title="Basic Settings">
  ...
  The Optional Question Node output types carry the same functionality as the [Say Node](say.mdx).
...
To use AI-enhanced output rephrasing, read the [Generative AI](../../../empower/generative-ai.mdx) article.