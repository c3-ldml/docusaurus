...
<GridCards items={[
  {
    ...
    links: [
      {text: "Documentation", href: "say.mdx"}
    ]
  },
  {
    icon: "❓",
    ...
    links: [
      {text: "Documentation", href: "question.mdx"}
    ]
  },
  {
    icon: "❔",
    ...
    links: [
      {text: "Documentation", href: "optional-question.mdx"}
    ]
  },
  {
    icon: "📝",
    ...
    links: [
      {text: "Documentation", href: "send-text.mdx"}
    ]
  },
  {
    icon: "🐛",
    ...
    links: [
      {text: "Documentation", href: "debug-message.mdx"}
    ]
  },
  {
    icon: "💻",
    ...
    links: [
      {text: "Documentation", href: "code/overview.mdx"}
    ]
  }
]} />