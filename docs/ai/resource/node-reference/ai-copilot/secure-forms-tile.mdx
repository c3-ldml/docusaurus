...
Any credit card information will be securely stored within the [Cognigy PCI Vault](../../../../pci-vault/overview.mdx) product, which is PCI-certified.
...
- [PCI Vault](../../../../pci-vault/overview.mdx)