...
<a href="../../../../release-notes/4.69.mdx" /><img src="https://img.shields.io/badge/Added in-v4.69-blue.svg" alt="Version badge" />
...
- [Set HTML file](set-html-tile.mdx)
- [Set Adaptive card tile](set-adaptive-card-tile.mdx)
- [Set IFrame tile](set-iframe-tile.mdx)
