...
<a href="../../../../release-notes/4.90.mdx" /><img src="https://img.shields.io/badge/Added in-v4.90-blue.svg" alt="Version badge" />
...
|-----------|---------------|-------------------------------------------------------------------------------------------------------------------------------------------|
| Tile ID   | CognigyScript | The ID of the [Copilot: IFrame Tile](set-iframe-tile.mdx) or [Copilot: HTML Tile](set-html-tile.mdx) Node you want to update with new data. |
| JSON Data | JSON          | The data to send to the [Copilot: IFrame Tile](set-iframe-tile.mdx) or [Copilot: HTML Tile](set-html-tile.mdx) Node as a postMessage event. |
