...
<CollapsibleSection title="Example">
    ...
    <html lang="en">
      <head>
        ...
        <script src="https://unpkg.com/react@18/.mdx/react.production.min.js"></script>
        <script src="https://unpkg.com/react-dom@18/.mdx/react-dom.production.min.js"></script>
...
<CollapsibleSection title="Postback">
    ...
    In the AI Copilot Flow, below the Copilot: HTML Tile Node, add a [Copilot: Send Data](send-data.mdx).
