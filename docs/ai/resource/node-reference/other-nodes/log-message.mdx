...
This Node writes a message into the [Project Logs](../../../test/logs.mdx).
...
To log messages, you can also use the [Actions/API](../basic/code/actions.mdx) object in a [Code](../basic/code/overview.mdx) Node.

If you want to send a debug message to the Interaction Panel, use the [Debug Message](../basic/debug-message.mdx) Node for more precise testing.