...
For more information, refer to the [list of supported providers](../../../empower/llms/model-support-by-feature.mdx).
...
<Tabs>
  <TabItem value="tab1" label="Search & Extract & Output" default>
    ...
    For this mode, select models from the [list of supported providers](../../../empower/llms/model-support-by-feature.mdx) that cover the `LLM Prompt Node`, `Answer Extraction`, and `Knowledge Search` cases.
  ...
  <TabItem value="tab2" label="Search & Extract">
    ...
    For this mode, select models from the [list of supported providers](../../../empower/llms/model-support-by-feature.mdx) that cover both the `LLM Prompt Node`, `Answer Extraction`, and `Knowledge Search` cases.
  ...
  <TabItem value="tab3" label="Search Only">
    ...
    For this mode, select models from the [list of supported providers](../../../empower/llms/model-support-by-feature.mdx) that cover the `Knowledge Search` case.
...
- [Knowledge Search Node](knowledge-search.mdx)
- [Knowledge Search Overview](../../../empower/knowledge-ai/overview.mdx)
- [LLM](../../../empower/llms/overview.mdx)
