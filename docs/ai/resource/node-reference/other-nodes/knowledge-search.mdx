...
<a href="../../../../release-notes/4.61.mdx" /><img src="https://img.shields.io/badge/Updated in-v4.61-blue.svg" alt="Version badge" />
...
:::danger[Removal of the Knowledge Search Node]
  ...
  The Knowledge Search Node was removed from Cognigy.AI in version 4.61. If you use this Node, it will still work, but you won't be able to create new Knowledge Search Nodes. To ensure a seamless transition, we strongly recommend using the [Search Extract Output](search-extract-output.mdx) Node, as it offers the same functionality and additional features.

  This Node searches and retrieves content from data that was previously uploaded to the Knowledge AI solution.

  Before using this Node, ensure that you have a `text-embedding-ada-002` LLM configured. Refer to the [list of supported providers](../../../empower/llms/model-support-by-feature.mdx). 
...
- [Search Extract Output](search-extract-output.mdx) 
