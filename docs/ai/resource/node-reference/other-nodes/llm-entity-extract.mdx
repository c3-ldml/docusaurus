...
<a href="../../../../release-notes/4.97.mdx" /><img src="https://img.shields.io/badge/Added in-v4.97-blue.svg" alt="Version badge" />
...
To output the result, below the LLM Entity Extract Node, add a [Say Node](../basic/say.mdx). In the **Text** field of the Say Node, use a key specified in the Storage Options, for example, `{{ "{{input.extractedEntity}}" }}`.
...
- [Question Node: LLM-extracted Entity](../basic/question.mdx#)
