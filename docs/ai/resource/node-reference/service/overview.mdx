...
<GridCards items={[
  {
    ...
    links: [
      {text: "Documentation", href: "add-transcript-steps.mdx"}
    ]
  },
  {
    icon: "👥",
    ...
    links: [
      {text: "Documentation", href: "check-agent-availability.mdx"}
    ]
  },
  {
    icon: "❌",
    ...
    links: [
      {text: "Documentation", href: "close-handover.mdx"}
    ]
  },
  {
    icon: "📝",
    ...
    links: [
      {text: "Documentation", href: "get-transcript.mdx"}
    ]
  },
  {
    icon: "🤖",
    ...
    links: [
      {text: "Documentation", href: "gpt-conversation.mdx"}
    ]
  },
  {
    icon: "🔄",
    ...
    links: [
      {text: "Documentation", href: "handover-to-agent.mdx"}
    ]
  },
  {
    icon: "🌐",
    ...
    links: [
      {text: "Documentation", href: "http-request.mdx"}
    ]
  },
  {
    icon: "🧠",
    ...
    links: [
      {text: "Documentation", href: "llm-prompt.mdx"}
    ]
  },
  {
    icon: "🗄️",
    ...
    links: [
      {text: "Documentation", href: "mongo-db.mdx"}
    ]
  },
  {
    icon: "💾",
    ...
    links: [
      {text: "Documentation", href: "ms-sql.mdx"}
    ]
  },
  {
    icon: "⏰",
    ...
    links: [
      {text: "Documentation", href: "set-handover-inactivity.mdx"}
    ]
  },
  {
    icon: "⚡",
    ...
    links: [
      {text: "Documentation", href: "trigger-function.mdx"}
    ]
  }
]} />
