...
:::warning
  ...
  This Node isn't compatible with the `@cognigyRecentConversation` and `@cognigyRecentUserInputs` tags in the [LLM Prompt Node](llm-prompt.mdx).
...
- [Get Transcript](get-transcript.mdx)
