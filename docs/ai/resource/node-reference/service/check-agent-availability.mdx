...
<CollapsibleSection title="Genesys Cloud">
    ...
    These settings are applicable to both [Genesys Cloud Guest Chat](../../../human-escalation/handover-reference/genesys-cloud-guest-chat.mdx) and [Genesys Cloud Open Messaging](../../../human-escalation/handover-reference/genesys-cloud-open-messaging.mdx).
...
To test your Flow, use [Demo Webchat](../../../../webchat/demo.mdx).
...
- [Agent to Handover Node](../../../human-escalation/handover-reference/live-agent.mdx)
- [IF Node](../logic/if.mdx)
- [Say Node](../basic/say.mdx)