...
<CollapsibleSection title="Custom Options">
    ...
    **Forcing Model Versions**
    ...
    1. [Create an Anthropic LLM resource](../../../empower/llms/providers/anthropic.mdx) for Claude-1, for example, `claude-3-opus-20240229`.
...
- [GPT Conversation Node](gpt-conversation.mdx)