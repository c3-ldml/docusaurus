...
who are using the [Knowledge AI features](../../empower/knowledge-ai/overview.mdx).
...
Cognigy.AI releases 4.65.0 and earlier use Weaviate 1.19.0 as the vector database for the [Knowledge AI features](../../empower/knowledge-ai/overview.mdx).
...
- Kubernetes cluster meets general Cognigy.AI [prerequisites](../prerequisites.mdx#whitelisting-of-domains), including hardware resources.
