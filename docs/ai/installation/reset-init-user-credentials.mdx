...
In case,
you cannot obtain credentials from logs of `service-security` in the way it is described in the [Cognigy.AI installation process](installation-process.mdx) article,
for example,
