...
import onPremCompatibilityMatrixNote from '@site/docs/_includes/installation/_on-prem-compatibility-matrix-note.mdx';
...
[^****]: Only when [Knowledge AI](../empower/knowledge-ai/overview.mdx) is enabled.
...
- [AI Copilot (4.64 and earlier versions)](../../ai-copilot/installation/version-compatibility-matrix.mdx)
- [Voice Gateway](../../voice-gateway/installation/version-compatibility-matrix.mdx)