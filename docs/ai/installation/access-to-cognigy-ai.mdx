...
You will receive an email with instructions to reset your password. You need to choose a password according to the [password policy](../administer/access/management-ui.mdx#password-policy) your admin set up. 

### Log in with Single Sign-on

In Cognigy.AI, you can set up [single sign-on (SSO)](single-sign-on-saml2.mdx) and, if necessary, you can [enforce login with SSO](single-sign-on-saml2.mdx) for your users.
...
In Cognigy.AI, you can be part of more than one [organization](../administer/access/management-ui.mdx#organizations). Each organization has a different login URL. For each organization, the login URL follows this pattern:
...
[![Version badge](https://img.shields.io/badge/Added in-v4.27.0-blue.svg)](../../release-notes/earlier-versions/cognigy-ai-pre-4.30.mdx)
