...
With **Cognigy.AI v4.10.0**, [Cognigy Insights](../../insights/overview.mdx) became the default analytics platform.
...
Customizing reports in Cognigy Insights is not possible. However, the data used to populate the reports is accessible via the [OData Analytics Endpoint](odata.mdx).