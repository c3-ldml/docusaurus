...
:::note
  ...
  We encourage you to explore the new version of Goals as soon as you migrate to the new [Insights framework](../../../insights/data-management/pre-aggregation.mdx).
  ...
  Goals provide a more comprehensive way to evaluate success compared to [Tasks](tasks.mdx).
...
3. By default, the report shows data for all goals from the last 30 days. Use [filters](../../../insights/global-filters.mdx) to view metrics by time, as well as for specific goals, Snapshots, Endpoints, or Locales.
...
For more information on how the data is calculated, refer to [Goals](../../../insights/reports/goals.mdx) in the Insights documentation.
...
4. Once the Package has created, a new [task](../../build/projects.mdx), titled **Create package**, will be run. To view the task, click ![task-menu](../../../../static/img/_assets/icons/task-menu.svg) in the upper-right corner.
...
1. [Create a Flow](../../build/flows/overview.mdx#working-with-flows).
...
Enable the [Debug Mode](../../test/interaction-panel/overview.mdx#debug-mode) setting to see when Track Goals will be triggered.
To view recorded metrics, go to [Cognigy Insights](../../../insights/index.mdx) and select [Goals](../../../insights/reports/goals.mdx) from the left-side menu.

## More Information

- [Track Goal](../../build/node-reference/analytics/track-goal.mdx)
- [Insights Goals Report](../../../insights/reports/goals.mdx)