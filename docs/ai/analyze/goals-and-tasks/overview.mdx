...
- **Focused Analysis**. If you need a detailed analysis of specific interactions, Goals and Tasks can be combined with [Analytics Steps](../collecting-data.mdx#analytics-steps) to get a comprehensive view of user interactions.
...
| Configuration    | Add a title and description to a step. If the Node is executed, the step will be recorded in the Analytics database.                                                                                     | Add the [Complete Task](../../build/node-reference/analytics/complete-task.mdx) Node to the Flow.                                                                                                                                                                                                              | Create a Goal and include steps in the goal. Distribute the steps using the [Track Goal Node](../../build/node-reference/analytics/track-goal.mdx) in the Flow. |
| Integration      | Integration with the Insights [Step explorer](../../../insights/explorers/step.mdx), as well as the OData Endpoint [Steps](../odata.mdx#steps) and [ExecutedSteps](../odata.mdx#executedsteps) collections. | Integration with the [Contact Profile](../contact-profiles.mdx), the Insights [Overview](../../../insights/reports/overview.mdx) and [Engagement](../../../insights/reports/engagement.mdx) reports, and the OData Endpoint [Sessions](../odata.mdx#sessions) and [Analytics](../odata.mdx#analytics) collections. | Improved integration with Insights ([Goals report](../../../insights/reports/goals.mdx)) and OData and enhanced data reporting features.                        |
