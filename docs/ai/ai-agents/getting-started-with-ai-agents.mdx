...
An [Agentic AI Agent](../../ai/empower/agentic-ai/overview.mdx) is advanced conversational intelligence powered by a Large Language Model
(LLM),
...
- [LLM](../../ai/empower/llms/model-support-by-feature.mdx) for language generation, for example, OpenAI GPT-4o.
- [LLM](../../ai/empower/llms/model-support-by-feature.mdx) for embeddings generation, for example, OpenAI ada-002.
...
Generative models may lack company-specific knowledge. To improve accuracy, use [Cognigy Knowledge AI (RAG)](../../ai/empower/knowledge-ai/overview.mdx) by integrating external knowledge sources.
...
<img src={require('../../../static/img/_assets/ai/overview/ai-agent-tool-action.png').default} width="70%" style={{ display: 'block', margin: '0 auto' }} />
...
<img src={require('../../../static/img/_assets/ai/overview/ai-agent-memory.png').default} width="70%" style={{ display: 'block', margin: '0 auto' }} />
...
[Cognigy.AI Endpoints](../../ai/deploy/endpoint-reference/overview.mdx) allow AI Agents to interact with external users via chat and voice channels.
