...
- Familiarize yourself with the core concepts of building AI Agents, such as [Projects](../resource/projects.md), [Flows](../resource/flows/overview.md), [Nodes](../resource/nodes/overview.md), and [Cognigy Script](../resource/cognigyscript.md).
...
- Connect your agent to the [contact center](../human-escalation/handovers.md).
