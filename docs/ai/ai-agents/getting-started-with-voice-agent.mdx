...
You can login with your Cognigy.AI credentials or, optionally, with single sign-on (SSO), if you have [set up login with SSO](../../ai/installation/single-sign-on-saml2.mdx). If you have [enforced login with SSO](../../ai/installation/single-sign-on-saml2.mdx#enforce-login-with-sso), you can only log in with SSO.
...
For these steps, refer to the [Voice Gateway](../../voice-gateway/overview.mdx) documentation.
