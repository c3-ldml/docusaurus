...
To build a chat AI Agent using Cognigy.AI, you need to start by creating a [Project](../resource/projects.mdx) and a [Flow](../resource/flows/overview.mdx).
Once created, you can add at least [basic Nodes](../resource/node-reference/overview.mdx) such as Say and Question Nodes,
...
For example, select the [Webchat v3 Endpoint](../../webchat/v3/configuration.mdx) if you want to connect the AI Agent to the [Cognigy Webchat v3 widget](../../webchat/v3/overview.mdx), the [WhatsApp Endpoint](../deploy/endpoint-reference/whatsapp.mdx) to connect it to WhatsApp Messenger, or the [Slack Endpoint](../deploy/endpoint-reference/slack.mdx) to connect it to the Slack platform. To choose the best one for your needs, refer to the [full list of available Endpoints](../deploy/endpoint-reference/overview.mdx).
...
you need to start by creating a [Project](../resource/projects.mdx) and a [Flow](../resource/flows/overview.mdx).
However, in addition to the [basic Nodes](../resource/node-reference/overview.mdx),
you also need
to add [voice Nodes](../resource/node-reference/voice/voice-gateway/overview.mdx)
...
For seamless connectivity, we recommend using the [Voice Gateway](../deploy/endpoint-reference/voice-gateway.mdx) Endpoint.
...
For more information, read the [Voice Gateway](../../voice-gateway/getting-started.mdx) documentation.
...
Cognigy.AI offers a [marketplace of prebuilt extensions](../resource/extensions.mdx) and [custom Nodes](../developers/extension-framework.mdx)
...
By using advanced AI technologies like [Generative AI](../empower/generative-ai.mdx), [Natural Language Understanding (NLU)](../empower/nlu/overview.mdx), and [Knowledge AI](../empower/knowledge-ai/overview.mdx),
...
Also, you can make your AI Agent [fully driven by Large Language Models (LLMs)](../empower/agentic-ai/overview.mdx), tailoring its personality to align with your brand and customer preferences.
...
- [Key Features](key-features.mdx)
- [Build Your Chat-Based AI Agent in Minutes](getting-started-with-digital-agent.mdx)
- [Build Your Voice AI Agent in Minutes](getting-started-with-voice-agent.mdx)