...
- Created Endpoint [compatible with Chatwoot](../../deploy/endpoints/handover-settings.mdx#endpoints-compatible-with-handover-providers).
...
:::info[2. Add a Handover to Agent Node]
  ...
  3. In the **Chatwoot Inbox Id** field, enter the Inbox ID. You can use [CognigyScript](../../build/cognigyscript.mdx) to dynamically select an Inbox ID based on the conversation context.
...
- [All Providers](overview.mdx)
- [Handover](../handovers.mdx)