...
<img src={require('../../../../static/img/_assets/ai/human-escalation/handover-reference/8x8.svg').default} width="80%" />
...
- Created Endpoint [compatible with 8x8](../../deploy/endpoints/handover-settings.mdx#endpoints-compatible-with-handover-providers).
...
:::info[2. Configure Handover Settings]
  ...
  In the [Handover to Agent](../../build/node-reference/service/handover-to-agent.mdx) Node, configure the following settings:
...
<CollapsibleSection title="AI Copilot Workspace">
  ...
  Within 8x8 integration, you can use the [AI Copilot workspace](../../../ai-copilot/overview.mdx) as an assistant for to human agents. AI Copilot will be available as a standalone application via the following link:
...
- [8x8 Endpoint](../../deploy/endpoint-reference/8x8.mdx)
- [AI Copilot Workspace](../../../ai-copilot/overview.mdx)
