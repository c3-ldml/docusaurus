...
import FilterTranscriptMessages from '@site/docs/_includes/ai/providers/genesys/_filter-transcript-messages.mdx';
...
- Created Endpoint [compatible with Genesys Cloud Guest Chat](../../deploy/endpoints/handover-settings.mdx#endpoints-compatible-with-handover-providers).
...
Within Genesys integration, you can use the [AI Copilot workspace](../../../ai-copilot/overview.mdx) as an assistant for your human agents.
...
- [Genesys Cloud Open Messaging](genesys-cloud-open-messaging.mdx)