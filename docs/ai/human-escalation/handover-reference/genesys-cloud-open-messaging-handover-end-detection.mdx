...
:::warning
  ...
  If you use Cognigy.AI 4.100 or later versions, migrate to [Amazon EventBridge](genesys-cloud-open-messaging-with-amazon-eventbridge.mdx). Remove the previous [configuration steps](#configuration-steps) after migration to Amazon EventBridge.
...
- Applicable to Cognigy.AI 4.99 and earlier versions. If you use Cognigy.AI 4.100 or later versions, migrate to [Amazon EventBridge](genesys-cloud-open-messaging-with-amazon-eventbridge.mdx).
