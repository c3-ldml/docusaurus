...
<a href="../../../release-notes/4.97.mdx" /><img src="https://img.shields.io/badge/Added in-v4.97.0-blue.svg" alt="Version badge" />
...
- Created Endpoint [compatible with RingCentral Engage](../../deploy/endpoints/handover-settings.mdx#endpoints-compatible-with-handover-providers).
...
:::info[Get Queue Updates]
  ...
  In addition to enabling the **Get Queue Update** option, you need to configure the Lookup Node so that the handover type is selected as **Queue**. For more details, refer to the [Handover Status](../../build/node-reference/logic/lookup.mdx#handover-status) section.
