...
import UrlPattern from '@site/docs/_includes/ai-copilot/_url-pattern.mdx';
import CollapsibleSection from '@site/src/components/CollapsibleSection';

# Salesforce MIAW

<a href="../../../release-notes/4.100.mdx" /><img src="https://img.shields.io/badge/Added in-v4.100-blue.svg" alt="Version badge" />
...
- Created Endpoint [compatible with Salesforce](../../deploy/endpoints/handover-settings.mdx#endpoints-compatible-with-handover-providers).
...
:::info[2. Add a Handover to Agent Node]
  ...
  In the **Salesforce Settings** section of the [Handover to Agent](../../build/node-reference/service/handover-to-agent.mdx) Node, configure the following settings:
...
Within the Salesforce MIAW integration, you can use the [AI Copilot workspace](../../../ai-copilot/overview.mdx) as an assistant to your human agents.
...
:::info[Embedded]
  ...
  To configure the AI Copilot UI components, refer to the [Salesforce Integrations](https://github.com/Cognigy/salesforce-integrations) documentation on GitHub. Once the components are configured, you can test the embedded AI Copilot workspace using [Demo Webchat](../../../webchat/demo.mdx).

  If you used an embedded AI Copilot workspace with the [deprecated Salesforce integration](salesforce.mdx) and migrated to Salesforce MIAW, you need to update the AI Copilot UI components. Refer to the [Set up the Component](https://github.com/Cognigy/salesforce-integrations?tab=readme-ov-file#set-up-the-componentrefer) documentation on GitHub.
...
| You are trying to pull data from a Live Chat transcript while you are on a Messaging session.   | This error occurs when you migrate from the [deprecated Salesforce integration](salesforce.mdx) to Salesforce MIAW without updating the AI Copilot UI components. To update the components, refer to the [Set up the Component](https://github.com/Cognigy/salesforce-integrations?tab=readme-ov-file#set-up-the-componentrefer) documentation on GitHub. |
...
- [All Handover Providers](overview.mdx)
- [Handovers](../handovers.mdx)