...
<a href="../../release-notes/4.53.mdx" /><img src="https://img.shields.io/badge/Added in-v4.53-blue.svg" alt="Version badge" />
...
- A [handover provider](handover-reference/overview.mdx), for example, [Cognigy Live Agent](handover-reference/live-agent.mdx), is configured.
- The Endpoint that supports a selected handover provider is configured. For testing purposes, you can use the [Webchat v3 Endpoint](../../webchat/v3/overview.mdx) with [Demo Webchat](../../webchat/demo.mdx).
...
- [Set Handover Inactivity](../build/node-reference/service/set-handover-inactivity.mdx)
- [Close Handover](../build/node-reference/service/close-handover.mdx)
- [Handover Providers](handover-reference/overview.mdx)
- [Agent Handover](../build/node-reference/service/handover-to-agent.mdx)
- [Real-Time Queue Notifications](../../live-agent/conversation/conversation-queue/real-time-queue-notifications.mdx)