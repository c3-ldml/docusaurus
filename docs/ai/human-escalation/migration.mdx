...
The **Handover Providers** section in the [Endpoint settings](../../ai/deploy/endpoints/handover-settings.mdx) has been deprecated in 4.97, with removal planned for September 2025. 
