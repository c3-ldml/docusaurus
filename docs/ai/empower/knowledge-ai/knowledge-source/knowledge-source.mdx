...
- [Cognigy Text Format](text-formats/ctxt.mdx) (CTXT, recommended) 
- Files in the following formats:
    - [PDF](text-formats/pdf.mdx)
    - TXT
    - DOCX
    - PPTX
    - JPEG
    ...
    - HEIF
    - TIFF
- [Web Pages](text-formats/web-page.mdx)

Depending on the format of the file you use, you need to configure a specific [parser](text-extraction/overview.mdx) to convert the content into Knowledge Sources.
...
You can store Source metadata in the [Input object](../../../test/interaction-panel/input.mdx) or [Context object](../../../test/interaction-panel/context.mdx) and give your AI Agents access to the Source metadata through:
...
| `tags`  | This key defines [Knowledge Source Tags](knowledge-source-tags.mdx). To add more than Knowledge Source Tag, use an array. You can add up to 10 Knowledge Source Tags.            | no        | `[cognigy, xapps, architecture]`                                         |
...
<Tabs>
  ...
  <TabItem value="tab3" label="CLI">
    You can ingest documents to create Knowledge Sources and view the resulting number of tokens using the [Cognigy.AI CLI](https://github.com/Cognigy/Cognigy-CLI/blob/main/KNOWLEDGE-AI-README.mdx)
...
- [Knowledge Chunk](../knowledge-chunk/knowledge-chunk.mdx)
- [Knowledge Source Tags](knowledge-source-tags.mdx)
- [Chunk editor](../knowledge-chunk/knowledge-chunk-editor.mdx)
