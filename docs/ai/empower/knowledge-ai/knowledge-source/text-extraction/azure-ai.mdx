...
import metadata from '@site/docs/_includes/ai/knowledge-ai/_metadata.mdx';

# Azure AI Document Intelligence

<a href="../../../../../release-notes/4.80.mdx" /><img src="https://img.shields.io/badge/Added in-v4.80-blue.svg" alt="Version badge" />
...
:::note
  ...
  When you upload a file as a [Knowledge Source](../knowledge-source.mdx), Knowledge AI sends a request to Azure AI Document Intelligence to extract text from the file. After the text extraction, Knowledge AI retrieves the text, converts it into Markdown format, and splits it into Knowledge Chunk.
...
- **Improved quality of responses**. Breaking down the text into [Knowledge Chunks](../../knowledge-chunk/knowledge-chunk.mdx) allows AI Agents to understand the context and provide more accurate responses.
...
- [Text Extraction with Content Parsers](overview.mdx)
- [Advanced Parser](advanced-parser.mdx)
- [Basic Parser](basic-parser.mdx)
