...
The _Chunk editor_ is an interface for managing [Knowledge Chunks](knowledge-chunk.mdx) and editing their content.
...
To access the Chunk editor, select a Knowledge Store in **Build > Knowledge**, then a [Knowledge Source](../knowledge-source/knowledge-source.mdx).
...
:::info[Controls]
  ...
  | Button                                                                | Description                                                                                       |
  |-----------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
  | ![download](../../../../../static/img/_assets/voice-gateway/dowload.svg)            | You can download the Knowledge Source as a [CTXT file](../knowledge-source/text-formats/ctxt.mdx). |
...
- [Knowledge Chunk](knowledge-chunk.mdx)
