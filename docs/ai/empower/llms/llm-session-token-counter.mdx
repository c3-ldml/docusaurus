...
In Cognigy.AI, you can use the `api.getLLMTokenUsageForSession()` API call in a [Code Node](../../build/node-reference/basic/code/overview.mdx) or an [Extension](../../build/extensions.mdx) to fetch the Large Language Model (LLM) total token usage in a conversation or chat session. This way, you can track your [LLM providers](providers/all-providers.mdx) costs.
...
- You have added a Node that uses an LLM to your Flow, for example, an [AI Agent Node](../../build/node-reference/ai/ai-agent.mdx), [LLM Prompt Node](../../build/node-reference/service/llm-prompt.mdx), [Search Extract Output Node](../../build/node-reference/other-nodes/knowledge-search.mdx), or [AI Copilot Nodes](../../build/node-reference/ai-copilot/overview.mdx).
...
1. Add a [Code Node](../../build/node-reference/basic/code/overview.mdx) after the Node that uses an LLM, for example, after an [AI Agent Node](../../build/node-reference/ai/ai-agent.mdx).
...
:::info[Returned JSON Object]
  ...
  ```json
      {
          "1c945b38-5dbb-4fcf-9fdd-112bd8177f9c": {
              "I.mdxisplayName": "openAI - text- embedding-3-large - 1735891122507",
              "providerType": "openAI",
          ...
          "ce190e1f-eff7-4f6b-9074-9f705375a3d3": {
              "I.mdxisplayName": "openAI - gpt-40 - 1735891179896",
              "providerType": "openAI",
              "modelType": "gpt-40",
              "usage": {
                  "inputTokens": 441,
  ...
  | l.mdxisplayName | String | The name of the LLM.                                                                                                                                  | `openAI - gpt-40 - 1735891179896`      |
  ...
  For testing in the Interaction Panel, you can output the JSON object by adding `api.say()` at the end of your [Code Node](../../build/node-reference/basic/code/actions.mdx).
...
- [LLM Providers](providers/all-providers.mdx)
