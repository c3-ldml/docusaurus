...
:::info[Ensure LLM Accuracy with Human Review]
  ...
  AI Copilot provides [plug-and-play widgets](../../../ai-copilot/plug-and-play-widgets.md) in the [workspace](../../../ai-copilot/index.mdx), allowing human agents to review the output generated by LLMs before sending responses to customers. 
