...
To create and manage NLU connectors, read [External NLU](overview.mdx#creating-nlu-connectors) page.
...
To test and deploy an AI Agent using a third-party NLU, read [External NLU](overview.mdx#testing-and-deploying-with-an-external-nlu) page.
