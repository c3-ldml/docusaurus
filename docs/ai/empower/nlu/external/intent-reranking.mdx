...
<a href="../../../../release-notes/4.76.mdx" /><img src="https://img.shields.io/badge/Added in-v4.76-blue.svg" alt="Version badge" />
...
- Add an [external LLM](../../llms/model-support-by-feature.mdx) that supports the LLM Prompt Node & LLM-powered Answer Extraction features.
...
Alternatively, to view up to 5 probable results, you can output them via a [Say](../../../build/node-reference/basic/say.mdx) Node by including the [prompt](#add-an-llm-prompt-node) in the **Text** field.
...
- [Generate Intents](../../generative-ai.mdx#generate-intent-sentences)