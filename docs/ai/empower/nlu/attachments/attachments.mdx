...
:::note[Using Attached Flows]
  ...
  Find out more about flow attachment on the [Attached Flows Page](attached-flows.mdx).
...
:::note[Using Attached Lexicons]
  ...
  Find out more about lexicon attachment on the [Attached Lexicons Page](attached-lexicons.mdx).
