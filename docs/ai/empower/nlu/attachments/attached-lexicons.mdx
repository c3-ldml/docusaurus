...
In order to attach a Lexicon, it must first be created in the [Lexicons Editor](../slots-and-lexicons/lexicons.mdx). All available Lexicons that have been added to the agent will be populated in the *Attach Lexicon* list.
