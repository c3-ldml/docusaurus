...
To generate an API key, read [Create API Keys](../administer/user-menu/my-profile.mdx#create-api-keys).

To delete an API key, read [Revoke API Keys](../administer/user-menu/my-profile.mdx#revoke-api-keys).
