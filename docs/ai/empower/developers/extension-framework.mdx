...
- The framework doesn't support the creation of Nodes with child Nodes, such as [Lookup](../build/node-reference/logic/lookup.mdx) or [If](../build/node-reference/logic/if.mdx) Nodes. Within the Extension Framework, you can only create single Nodes without any dependent Nodes.
