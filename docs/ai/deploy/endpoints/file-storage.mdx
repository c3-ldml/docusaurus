...
import FileStorage from '@site/docs/_includes/ai/_file-storage.mdx';

# File Storage

<a href="../../../release-notes/4.91.mdx" /><img src="https://img.shields.io/badge/Updated in-v4.91-blue.svg" alt="Version badge" />
...
- [8x8](../endpoint-reference/8x8.mdx)
...
To test file uploads for the Webchat v2 and Webchat v3 Endpoints, use [Demo Webchat](../../../webchat/demo.mdx).
