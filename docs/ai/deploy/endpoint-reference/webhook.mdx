...
If you use [AI Copilot for voice](../../../ai-copilot/voice/voice-overview.mdx) with the Webhook Endpoint, you can switch to a specific [Voice Copilot](voice-copilot.mdx) Endpoint. This eliminates the need for a separate Code Node to create a webhook URL, as all the necessary logic is already included in the Voice Copilot Endpoint.
