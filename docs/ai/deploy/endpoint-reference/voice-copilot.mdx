...
The Voice Copilot Endpoint works with any [handover provider](../../human-escalation/handover-reference/overview.mdx) supported by Cognigy.
...
- [Voice Gateway](../../../voice-gateway/overview.mdx)