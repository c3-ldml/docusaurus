...
:::warning
  ...
  The Alexa Endpoint uses the Alexa NLU Connector. See the [NLU Connectors Page](../../empower/nlu/external/nlu-connectors.mdx) for more details.
...
Here you can log in directly to your Amazon account that has access to your Alexa skills. You can also log in to Amazon from the [My Profile](../../administer/user-menu/my-profile.mdx) page. Once logged in, you will be able to select the **Alexa Skill** that you wish to connect with your Cognigy.AI endpoint.
