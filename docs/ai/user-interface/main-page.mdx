...
<CollapsibleSection title="1. Project List">
    ...
    The ![plus](../../../static/img/_assets/icons/plus.svg) button opens the [Project Creation Wizard](../../resource/projects.mdx).
...
| ![user-menu](../../../static/img/_assets/icons/user-menu.svg) | Opens the [User Menu](../../administer/user-menu/overview.mdx).                                                                                           |
