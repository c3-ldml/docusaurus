...
| Hotkey                                           | Description                          |
|--------------------------------------------------|--------------------------------------|
| ++ctrl+c++<br />++.mdx+c++<br />++alt+"[drag/drop]"++ | Copy the Selected Node               |
| ++ctrl+v++<br />++.mdx+v++                          | Paste the Node from the Clipboard    |
| ++ctrl+x++<br />++.mdx+x++                          | Cut the Selected Node                |
| ++del++                                          | Delete the Selected Node             |
| ++ctrl+s++<br />++.mdx+s++                          | Save the node currently being edited |
| ++ctrl+alt+f++<br />++.mdx+opt+f++                  | Toggle the node search input field   |
| ++ctrl+alt+p++<br />++.mdx+opt+p++                  | Open Voice Preview panel             |
...
| Hotkey                     | Description           |
|----------------------------|-----------------------|
| ++ctrl+b++  <br /> ++.mdx+b++ | Clear the Chat        |
