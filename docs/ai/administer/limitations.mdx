...
:::note[Changing values for managed Cognigy.AI environments]
  ...
  | Maximum [Input](../test/interaction-panel/input.mdx) size                                                                          | 65 kB[^***]                     |            | **1.5 MB** |
  | Maximum [Context](../test/interaction-panel/context.mdx) size                                                                      | 65 kB[^***]                     |            | **1.5 MB** |
  | Maximum [Profile](../test/interaction-panel/profile.mdx) size                                                                      | 65 kB[^***]                     |            | **1.5 MB** |
  ...
  | Maximum message size for [Untrusted Extensions](../build/extensions.mdx#make-an-extension-trusted)                                 | 300 KB                          |            |            |
...
:::warning
  ...
  Features such as [OData](../analyze/odata.mdx) and [Insights](../../insights/overview.mdx) rely on records you will find in the **Data** section below.
...
:::note
  ...
  If you have on-premises Cognigy.AI environment, you can set TTL values system-wide via the Config Map and/or organization-wide via [Management UI](../administer/access/management-ui.mdx).
