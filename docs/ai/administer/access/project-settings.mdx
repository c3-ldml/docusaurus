...
Add a specific [Yes/No logic](../../empower/nlu/intents/yes-no-intents.mdx) within your Flow to confirm and negate an [Intent](../../empower/nlu/intents/ml-intents.mdx) or the **Yes/No** type of [Question Nodes](../../build/node-reference/overview.mdx).

### Additional confirmation words

Add your own customized responses to confirm an [Intent](../../empower/nlu/intents/ml-intents.mdx) and [Question Nodes](../../build/node-reference/overview.mdx).

### Additional negative confirmation words 

Add your own customized responses to negate an [Intent](../../empower/nlu/intents/ml-intents.mdx) and [Question Nodes](../../build/node-reference/overview.mdx).
...
To set up the connection between Cognigy.AI and the Generative AI Provider, read the [Generative AI](../../empower/generative-ai.mdx#prerequisites) article.
