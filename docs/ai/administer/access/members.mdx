...
The **Members** panel allows **Project Admins** to manage the **Roles** that users in an organization have for a specific Project. The roles assigned here are complimentary to the **Global Roles** assigned in the [Access Control](admin-center/access-control.mdx) panel.
...
:::note[Project Member Administration]
  ...
  | Knowledge Admin        | ![Version badge](https://img.shields.io/badge/Added in-v4.75.0-blue.svg) Adds the following permissions: full permissions for the [Knowledge AI](../../empower/knowledge-ai/overview.mdx) resources                                                                                                      |
  ...
  | Member Manager         | Adds the following permissions: <br /> - full permissions for Member Details <br /> - read permissions for the [Access Control](admin-center/access-control.mdx) page in the Admin Center                                                                                                                    |
  ...
  | Project Admin          | Adds the following permissions: <br /> - full access to all project resources (create, read, update, delete) <br /> - read permissions for the [Access Control](admin-center/access-control.mdx) page in the Admin Center                                                                                    |
