...
- Click **User Menu ![user-menu](../../../../../static/img/_assets/icons/user-menu.svg) > Admin Center** on the **Main** page, then select **Audit Events** from the left-side menu.
...
You can copy the JSON by clicking ![vertical-ellipsis](../../../../../static/img/_assets/icons/vertical-ellipsis.svg) **> Copy Event Details**.
