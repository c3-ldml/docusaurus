...
- [Project Roles](../members.mdx). These roles are specific to a Project. You can assign project-level roles via the [Members Panel](../members.mdx) to extend user permissions for creating, editing, viewing, and updating entities within a specific Agent.
...
| `voice-gatewayUser`   | This role is assigned to users with the [Account](../../../../voice-gateway/webapp/users.mdx#account) role to access the Voice Gateway Self-Service Portal, allowing them to authorize via their Cognigy.AI user credentials.                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
- `projectAdmin` – read-only access. See [Project Roles](../members.mdx#project-roles).
- `memberManager` – read-only access. See [Project Roles](../members.mdx#project-roles).
- `userManager` – full access. See [Global Roles](#global-roles).
- `userDetailsViewer` – read-only access. See [Global Roles](#global-roles).

## More Information

- [Members](../../access/members.mdx)
- [Admin Center](../../access/admin-center/overview.mdx)