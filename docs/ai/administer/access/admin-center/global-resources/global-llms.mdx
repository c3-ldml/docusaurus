...
_Global Large Language Models_ (LLMs) are [LLMs](../../../../empower/llms/overview.mdx) at [organization level](overview.mdx) that you can assign to and share across different Projects in your organization.

## Restrictions

- Global LLMs don't support [LLM fallback](../../../../empower/llms/fallback.mdx).
- Global LLMs can't be set as a [default model](../../../../empower/llms/other-operations.mdx#set-a-model-as-default).
<Tabs>
  <TabItem value="tab1" label="GUI" default>

    You can view, create, edit, and delete global LLMs in the [Admin Center](../overview.mdx) under **Resources > LLMs** as well as copy their Reference ID.
