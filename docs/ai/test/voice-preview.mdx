...
<a href="../../release-notes/4.97.mdx" /><img src="https://img.shields.io/badge/Updated in-v4.97.1-blue.svg" alt="Version badge" />
...
- Use the hotkey ++ctrl+alt+p++ or ++.mdx+opt+p++ in the Flow editor to open the Voice Panel.
...
- [Interaction Panel](interaction-panel/overview.mdx)
- [Voice Gateway](../../voice-gateway/index.mdx)
- [Voice Nodes](../resource/node-reference/voice/overview.mdx)
